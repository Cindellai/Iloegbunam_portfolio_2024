            ...
            <div className="mt-20 flex flex-col gap-8">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
                <Card className="h-[380px] md:col-span-2 lg:col-span-1">
                  <CardHeader
                    title="Records 💽"
                    description="Listen to my current fave"
                    className="flex"
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
                <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2">
                  <CardHeader
                    ...
                    description="Explore my interests and hobbies outside the digital realm"
                    className="px-6 py-6"
                  />
                  <div className="relative flex-1" ref={constraintRef}>
                    {hobbies.map((hobby) => (
                      <motion.div
                        key={hobby.title}
                        className="inline-flex items-center gap-2 px-6 bg-gradient-to-r from-purple-200 to-purple-300 rounded-full py-1.5 absolute"
                ...
                <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full bg-gradient-to-r from-orange-300 to-pink-400 after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:outline-offset-2 after:rounded-full after:outline-gray-950/30">
                    ...
                    <Image
                      src={smileMemoji}
                      alt="smiling"
                      className="size-13 translate-x-.9 -translate-y-9"
                    />
                  </div>
                </Card>
              </div>
