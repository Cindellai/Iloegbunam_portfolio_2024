    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <HeroOrbit size={800} rotation={-160} shouldOrbit orbitDuration="12s" shouldSpin spinDuration="5s">
          ...
          <HeroOrbit size={940} rotation={4} shouldOrbit orbitDuration="15s" shouldSpin spinDuration="2s">
            ...
            <HeroOrbit size={640} rotation={4} shouldOrbit orbitDuration="15s" shouldSpin spinDuration="2s">
            <SparkleIcon className="size-8 text-pink-900" />
            </HeroOrbit> 
          <HeroOrbit size={890} rotation={-100} shouldOrbit orbitDuration="20s" shouldSpin spinDuration="3s">
          ...
          <HeroOrbit size={500} rotation={80} shouldOrbit orbitDuration="32s" shouldSpin spinDuration="5s">
          ...
          <HeroOrbit size={700} rotation={-50} shouldOrbit orbitDuration="30s" shouldSpin spinDuration="5.5s">
